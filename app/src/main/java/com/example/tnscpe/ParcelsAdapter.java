                                        ...
                                        .addOnCompleteListener(task1 -> {
                                            if (task1.isSuccessful()) {
                                                ...
                                                if (userName.equals(parcelsModel.getOwner().getFirstname()) && userSurname.equals(parcelsModel.getOwner().getLastname())) {
                                                                            ...
                                                                            .addOnCompleteListener(task3 -> {
                                                                                if (task3.isSuccessful()) {
                                                                                    if (task3.getResult().get("checkIn") != null) {
                                                                                        Toast.makeText(context, "ขออภัยพัสดุนี้มาถึงแล้ว ไม่สามารถแก้ไขข้อมูลพัสดุได้", Toast.LENGTH_LONG).show();
                                                                                    } else {
                                                                                                                    ...
                                                                                                                    .setPositiveButton("ยืนยัน", (dialog, which) -> {
                                                                                                                        ...
                                                                                                                        db.collection("parcels").document(docIdParcels)
                                                                                                                                ...
                                                                                                                                .addOnFailureListener(new OnFailureListener() {
                                                                                                                                    @Override
                                                                                                                                    public void onFailure(@NonNull Exception e) {
                                                                                                                                        Toast.makeText(context, "กรุณาลองให้มในภายหลัง", Toast.LENGTH_SHORT).show();
                                                    ...
                                                    Toast.makeText(context, "ขออภัยท่านไม่ใช่เจ้าของพัสดุ", Toast.LENGTH_SHORT).show();
                                                }
                                            }
                                        });
                            }
